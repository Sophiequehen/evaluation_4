...
<body>
	...
	<section class="container">
		...
		?>
		<form method="POST" action="delete.php?id=<?php echo $id;?>" class="delete_nav">
			<a href="index.php" class="container_a_delete">Annuler</a>
			<button type="submit" class="container_button button_delete">Confirmer la suppression</button>
		</form>
	</section>
</body>
</html>